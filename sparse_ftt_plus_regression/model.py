"""
FTT+ Interprétable pour Régression - Modèle optimisé inspiré de RTDL avec Sparsemax
...
class InterpretableFTTPlusRegression(nn.Module):
    """FT-Transformer interprétable avec attention sélective FTT+ et sparsemax pour la régression.
    
    Cette implémentation adapte l'architecture robuste du FT-Transformer RTDL
    avec les innovations d'attention interprétable pour les tâches de régression sur données tabulaires.
    ...
    Args:
        ...
        d_out: dimension de sortie (1 pour régression univariée)
    ...
    Example:
        .. testcode::
            ...
            predictions, attention = model(x_num, x_cat)
    ...
    def __init__(
        ...
        *,
        ...
        # Tête de régression (pas d'activation finale pour permettre des valeurs continues)
        from rtdl_lib.modules import Transformer
    ...
    def get_baseline_config(cls) -> Dict[str, Any]:
        """Configuration baseline optimisée pour FTT+ interprétable pour la régression.
        
        Cette configuration suit les meilleures pratiques RTDL tout en
        optimisant pour l'interprétabilité des données tabulaires et la régression.
        ...
        return {
            ...
            'head_activation': 'ReLU',  # ReLU est suffisant pour la régression
    ...
    def make_baseline(
        ...
        *,
        ...
        d_out: int,
        attention_mode: str = 'hybrid',
    ) -> 'InterpretableFTTPlusRegression':
        """Crée un modèle FTT+ interprétable avec configuration baseline pour la régression.
        
        Cette méthode est le constructeur recommandé qui combine les
        meilleures pratiques RTDL avec les optimisations FTT+ pour la régression.
        ...
        Args:
            ...
            residual_dropout: taux de dropout des connexions résiduelles
            d_out: dimension de sortie (1 pour régression univariée)
            attention_mode: mode d'attention ('hybrid', 'sparse', 'full')
            
        Returns:
            InterpretableFTTPlusRegression: modèle configuré avec les paramètres baseline
        """
    ...
    def forward(self, x_num: Optional[Tensor], x_cat: Optional[Tensor], return_attention: bool = False) -> Union[Tensor, Tuple[Tensor, Tensor]]:
        ...
        Returns:
            predictions: valeurs prédites de forme (batch_size, d_out)
        ...
        if return_attention:
            return predictions, last_attention
        else:
            return predictions
