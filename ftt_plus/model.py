"""
FTT+ Interprétable - Modèle optimisé inspiré de RTDL
...
class InterpretableTransformerBlock(nn.Module):
    ...
    tout en intégrant le mécanisme d'attention interprétable FTT+.
...
class InterpretableFTTPlus(nn.Module):
    """FT-Transformer interprétable avec attention sélective FTT+.
    
    Cette implémentation combine l'architecture robuste du FT-Transformer RTDL
    avec les innovations d'attention interprétable pour données tabulaires.
    ...
    def __init__(
        ...
        *,
        ...
        # Blocs Transformer interprétables
